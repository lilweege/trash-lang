...
const char* tokenKindName(TokenKind kind) {
    ...
    const char* TokenKindNames[33] = {
        ...
        [TOKEN_OPERATOR_POS] = "TOKEN_OPERATOR_POS",
        [TOKEN_OPERATOR_NEG] = "TOKEN_OPERATOR_NEG",
        [TOKEN_OPERATOR_MUL] = "TOKEN_OPERATOR_MUL",
        [TOKEN_OPERATOR_DIV] = "TOKEN_OPERATOR_DIV",
        [TOKEN_OPERATOR_MOD] = "TOKEN_OPERATOR_MOD",
        [TOKEN_OPERATOR_COMMA] = "TOKEN_OPERATOR_COMMA",
        [TOKEN_OPERATOR_ASSIGN] = "TOKEN_OPERATOR_ASSIGN",
        [TOKEN_OPERATOR_EQ] = "TOKEN_OPERATOR_EQ",
        [TOKEN_OPERATOR_NE] = "TOKEN_OPERATOR_NE",
        [TOKEN_OPERATOR_GE] = "TOKEN_OPERATOR_GE",
        [TOKEN_OPERATOR_GT] = "TOKEN_OPERATOR_GT",
        [TOKEN_OPERATOR_LE] = "TOKEN_OPERATOR_LE",
        [TOKEN_OPERATOR_LT] = "TOKEN_OPERATOR_LT",
